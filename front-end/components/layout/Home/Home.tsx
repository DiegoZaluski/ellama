...
function Home() {
  ...
  const BorderCHAT = document.documentElement.getAttribute('data-theme') === 'dark' ? 'bg-black' : 'transparent'; 
  ...
  <div className={`
    ...
    >
      {isCollapsed ? <div className='bg-chat w-full h-full'></div>: <div className={`w-full h-full overflow-auto`}><Chat adaptable={true}/></div>}
