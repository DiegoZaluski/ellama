...
const STYLES = {
  ...
  tab: "min-w-[7rem] px-3 py-3 rounded-xl bg-color  transition-all duration-200 hover:bg-n-900 hover:dark-text-primary hover:scale-105 active:scale-95 cursor-pointer shadow-lg flex flex-col items-center justify-center", // Padding em vez de altura fixa
