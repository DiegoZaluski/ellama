...
from ScryPy.scry_http.routers.switch_routers import switch_routers
from ScryPy.scry_http.routers.configs_routers import configs_routers 
from ScryPy.scry_http.routers.prompt_router import prompt_router
